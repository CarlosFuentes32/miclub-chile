          ...
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="mt-2 text-3xl font-black text-violet-700">
                ...
                <small className="text-sm font-normal text-slate-400">/{p.billingPeriod === "YEARLY" ? "año" : "mes"}</small>
              </p>
              <p className="mt-1 text-xs font-bold text-slate-400">{p.currency ?? "CLP"} · {p.trialDays ?? 0} días prueba</p>
            </div>
