...
export interface CreateBusinessInput{name:string;businessType:string;rutBusiness?:string;address:string;phone:string;email:string;planId:string;ownerName:string;ownerEmail:string;ownerPhone:string;ownerPassword:string}
