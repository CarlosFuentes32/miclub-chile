...
export function LoginPage({ onLogin }: { onLogin: (u: AuthUser) => void }) {
  ...
  return (
    <main className="grid min-h-screen place-items-center bg-gradient-to-br from-cyan-950 to-violet-950 p-6">
      <form
        onSubmit={submit}
      ...
      >
        ...
        <p className="mt-6 text-sm font-black uppercase tracking-wider text-emerald-700">
          MiClub Chile
        </p>
